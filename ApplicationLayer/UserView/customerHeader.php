<meta charset="utf-8">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="customerMenu.php?id=<?php echo"$_SESSION[id]";?>">Event Management System</a>
...
<div>
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="customerMenu.php?id=<?php echo"$_SESSION[id]";?>">
